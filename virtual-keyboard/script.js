...
if (!keyboardRow1En.classList.contains('keyboard__row_inactive') && !keyboardRow1Rus.classList.contains('keyboard__row_inactive')) {
  keyboardRow1Rus.classList.add('keyboard__row_inactive');
}
...
keyboardRow2Rus.classList.add('keyboard__row_inactive');
...
keyboardRow3Rus.classList.add('keyboard__row_inactive');
...
keyboardRow4Rus.classList.add('keyboard__row_inactive');
...
keyboardRow5Rus.classList.add('keyboard__row_inactive');
  ...
  if (target.classList.contains('keyboard__button')) {
    ...
    if (target.classList.contains('AltLeft')) {
      ...
      keyboardRows.forEach((row) => {
        row.classList.toggle('keyboard__row_inactive')
      })
    }
